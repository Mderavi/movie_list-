      ...
      <Main>
        <Box>
          ...
          {!isLoding && !error && (
            <MovieList
              movies={movies}
              onsSelectMovie={handelSelectedMovie}
...
function MovieList({ movies, onsSelectMovie }) {
  return (
...
function Movie({ movie, onsSelectMovie }) {
  return (
    <li onClick={() => onsSelectMovie(movie.imdbID)}>
  ...
  useEffect(
    function () {
      ...
      return function () {
        ...
        // console.log(`Cleanupeffect for movie ${title}`);
      };
    },
    [title]
  );
